      ...
      if (!c.ids[g]) {
        ...
        setTimeout(function () {
          ...
          try {
            ...
            // Without this line, firefox fails with "Uncaught TypeError: b.contentWindow.document.body is null"
            // It generates a violation but the code that follows continues working.
            l.write(
              [
